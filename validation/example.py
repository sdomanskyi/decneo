...
hum_endo_cell_list = [value for value in endo_cells_list if value in list(human_count_df.columns)] 
...
mus_endo_cell_list = [value for value in endo_cells_list if value in list(mouse_count_df.columns)] 
